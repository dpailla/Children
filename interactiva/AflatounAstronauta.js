...
class AflatounAstronauta extends Phaser.State {
    ...
    create() {
        ...
        const aflatoun = this.game.add.sprite(this.world.width / 2, this.world.height, 'astronauta');
        ...
        const text = this.game.add.text(this.game.world.centerX, margenTop, 'Hola amigos! Por fin consegui el traje de astronauta. Quiero de grande ir a la luna pero para eso tengo que esforzarme por estudiar mucho. Que quieren ser ustedes?', style);
        text.anchor.set(0.5);
        text.y = text.y + text.height / 2;
    }
}
export default AflatounAstronauta;
//# sourceMappingURL=AflatounAstronauta.js.map