...
class DefinisteTuSueno extends Phaser.State {
    ...
    create() {
        ...
        const text = this.game.add.text(this.game.world.centerX, margenTop, '¿Definiste tu sueño? No esperes más y empieza a llevarlo a la realidad. Aflatoun Habla.', style);
        text.anchor.set(0.5);
        text.y = text.y + text.height / 2;
    }
}
export default DefinisteTuSueno;
//# sourceMappingURL=DefinisteTuSueno.js.map