...
class GameState extends Phaser.State {
    create() {
        ...
        const higherButton = this.game.add.button(160, 100, 'higher', this.clickedHigher, this);
        higherButton.anchor.setTo(0.5, 0.5);
        const lowerButton = this.game.add.button(160, 380, 'lower', this.clickedLower, this);
    ...
    enterNumber() {
        this.workingButtons = true;
        if ((this.higher && this.spriteNumber.frame < this.num) ||
